package com.example.titancalculator.rjm_notused;
...
public class Rational implements Cloneable, Comparable<Rational>
{
        ...
        */
        ...
        /** ConversionActivity to an integer value, if this can be done exactly.
        * @since 2011-02-13
        * @author Richard J. Mathar
        */
        int intValue()
        ...
        /** ConversionActivity to a BigInteger value, if this can be done exactly.
        * @since 2012-03-02
        * @author Richard J. Mathar
        */
